...
uint256 hashGenesisBlock("0x260a72b9fe64706d3de8b86da48e6689ecd70aa223146bd0be6a4758a5310795");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Fishcoin: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1000000); // Fishcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2500000; // Fishcoin: 3.5 days
static const int64 nTargetSpacing = 60; // Fishcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x927bb9a2324fc72749ab9b4be01cc15db3de932d39356ca1c69407bcc6185fd6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("3e6183d96c814786f4330c0a73eb7e09ecdea4bd769bf04da071f08b6fc35c92599c1b02a4299233df39ddde6b9ebf7183bffdc2b9d9c4a74ab81eb114daa5e872") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1515616697;
        block.nBits    = 504365644;
        block.nNonce   = 1656254396;

        if (fTestNet)
        {
            block.nTime    = 1515616697;
            block.nNonce   = 2640196358;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x76bf2822999f256e99f47bf68ea2bff3966fe5d645ccc1fb75085ab898e7399b"));
        block.print();
